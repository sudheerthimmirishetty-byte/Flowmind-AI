          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => fill('hr@company.com','hr123')} className="text-xs text-blue-600 hover:underline font-medium">hr@company.com / hr123</button>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-slate-600">Employee:</span>
                <button onClick={() => fill('employee@company.com','emp123')} className="text-xs text-blue-600 hover:underline font-medium">employee@company.com / emp123</button>
              </div>
            </div>
          </div>
